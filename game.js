...
const tasks = [
  { x: 180, y: 120, w: 42, h: 42, color: '#ff6262', label: 'O2 Filtre', completed: false },
  { x: 700, y: 150, w: 42, h: 42, color: '#4fd1c5', label: 'Elektrik Paneli', completed: false },
  { x: 180, y: 390, w: 42, h: 42, color: '#f2b84b', label: 'Yedek Kartuş', completed: false },
];
...
const npcs = [
  { x: 120, y: 100, radius: 16, color: '#8b9cff', role: 'crewmate', vx: 60, vy: 40, revealed: false },
  { x: 690, y: 280, radius: 16, color: '#ffd166', role: 'crewmate', vx: -60, vy: 30, revealed: false },
  { x: 500, y: 440, radius: 16, color: '#98fb98', role: 'crewmate', vx: 50, vy: -40, revealed: false },
  { x: 260, y: 180, radius: 16, color: '#4fd1c5', role: 'crewmate', vx: 45, vy: -20, revealed: false },
  { x: 600, y: 120, radius: 16, color: '#ff8f5b', role: 'crewmate', vx: -35, vy: 50, revealed: false },
  { x: 340, y: 390, radius: 16, color: '#c48cff', role: 'crewmate', vx: 55, vy: -45, revealed: false },
  { x: 760, y: 380, radius: 16, color: '#ff4d6d', role: 'impostor', vx: -70, vy: 25, revealed: false },
];
...
function update(delta) {
  ...
  npcs.forEach((npc) => {
    ...
    if (npc.x < 40 || npc.x > canvas.width - 40) npc.vx *= -1;
    if (npc.y < 40 || npc.y > canvas.height - 40) npc.vy *= -1;
...
function draw() {
  ...
  // Player
  drawCharacter(player.x, player.y, playerTitleText === 'Ada Kurucu' ? '#ffd166' : '#4cb0ff', true);
}
